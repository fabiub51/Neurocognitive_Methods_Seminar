...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.meeg.convert.dataset = {'/Users/fabiusberner/Documents/UNI/2. Semester/NMDA practical /EEG/data_dir/subject1.bdf'};
matlabbatch{1}.spm.meeg.convert.mode.continuous.readall = 1;
matlabbatch{1}.spm.meeg.convert.channels{1}.chanfile = {'/Users/fabiusberner/Documents/UNI/2. Semester/NMDA practical /EEG/data_dir/channelselection.mat'};
...
matlabbatch{2}.spm.meeg.preproc.montage.mode.write.montspec.montage.montagefile = {'/Users/fabiusberner/Documents/UNI/2. Semester/NMDA practical /EEG/data_dir/avref_eog.mat'};
...
matlabbatch{3}.spm.meeg.preproc.prepare.task{1}.loadeegsens.eegsens = {'/Users/fabiusberner/Documents/UNI/2. Semester/NMDA practical /EEG/data_dir/sensors.pol'};
...
matlabbatch{7}.spm.meeg.preproc.epoch.trialchoice.trlfile = {'/Users/fabiusberner/Documents/UNI/2. Semester/NMDA practical /EEG/data_dir/trialdef.mat'};
